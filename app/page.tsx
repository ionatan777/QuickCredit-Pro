...
import { CheckCircle2, TrendingUp, Zap, Shield, BarChart3, Users } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold">QuickCredit Pro</h1>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <div className="text-center">
                ...
                <div className="text-sm text-green-100">Evaluación</div>
              </div>
              <div className="text-center">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
            ...
            <p className="text-slate-600">Decisión crediticia en menos de 30 segundos con IA</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
            ...
            <p className="text-slate-600">Política crediticia configurable y auditable</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
            ...
            <h3 className="text-lg font-bold mb-2">Analytics en Tiempo Real</h3>
            <p className="text-slate-600">Dashboard con métricas de aprobación y riesgo</p>
          </div>
        </div>
